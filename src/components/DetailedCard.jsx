...
function DetailedCard({ display = "hidden" }) {
    ...
    return (
        ...
        <div  className={` rounded-3xl flex items-center justify-center flex-col sm:flex-col lg:flex-row md:flex-row fixed  top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-[75vh] sm:h-[75vh] md:h-[50vh] lg:h-[50vh] w-[80vw] overflow-hidden bg-gray-500 border border-zinc-700`}>
